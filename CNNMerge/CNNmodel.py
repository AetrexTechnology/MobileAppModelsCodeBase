...
with open('../regression_modeldata1/groundtruth.json') as json_file:
...
model.fit([X_img_train, X_num_train], [yL_train, yR_train], batch_size=8, validation_split=0.2, epochs=100, verbose=1)
