...
directory = '/Users/vaneesh_k/Downloads/cnn_regression_data/200_data'
...
checkPoint = keras.callbacks.ModelCheckpoint('./cnnmerge_distancecamera_kumarmodel/weights{epoch:08d}.h5',
