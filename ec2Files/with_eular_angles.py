...
with open('../testingdata1/groundtruth1.json') as json_file:
...
datagenerator = customDataAugGenerator(X_img_train, finalX_num, yL_train, yR_train, 2)
...
model.fit_generator(datagenerator, validation_steps=True, steps_per_epoch=len(X_img_train) / 2, epochs=5000, verbose=1,
