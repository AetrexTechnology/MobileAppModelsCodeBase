...
# parameters
working_dir = '/Users/vaneesh_k/Downloads/4880_7569_bundle_archive/shapes'
...
for folder in folders:
    print(folder)
    for path in os.listdir('/Users/vaneesh_k/Downloads/4880_7569_bundle_archive/shapes' + '/' + folder):
...
checkPoint = keras.callbacks.ModelCheckpoint('./weights_Coins/weights_{epoch:08d}.h5',
                                             save_best_only=True)
# three layers
...
history = model.fit(train_data, train_labels_one_hot, batch_size=256, epochs=5000, verbose=1,
                    validation_data=(test_data, test_labels_one_hot), callbacks=checkPoint)
